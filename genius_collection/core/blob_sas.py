...
def create_user_delegation_blob_sas(blob_client: BlobClient, user_delegation_key: UserDelegationKey):
...
def get_blob_sas_url(blob_name: str) -> str:
    ...
    blob_client = blob_service_client.get_blob_client(container="portraits", blob=blob_name)
